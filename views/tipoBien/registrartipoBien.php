    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Registrar tipo de Bien</h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL; ?>tipoBien/guardar" id="form" >
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="tipo"><b>Nombre del tipo de bien</b></label>
