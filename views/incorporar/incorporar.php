    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <?php if(in_array("Crear Asignar Bien", $_SESSION['bn_permisos'])){ ?>
                    <a href="<?= BASE_URL; ?>incorporar/registrarIncorporaciones" class="btn btn-primary btn-sm btn-icon-split">
