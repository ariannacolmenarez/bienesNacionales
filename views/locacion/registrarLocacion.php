    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Registrar Locación</h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL; ?>locacion/guardar" id="form">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="id"><b>ID</b></label>
                                <input type="text" class="form-control bg-light" name="id"  placeholder="ID generado" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="locacion"><b>Locación</b></label>
                                <input type="text" class="form-control bg-light" id="nombre" name="locacion" placeholder="Escriba el nombre de la locacion"maxlength="50" pattern="[a-zA-ZÀ-ÿ\s0-9]{2,50}" required>
                            </div>
                        </div>
