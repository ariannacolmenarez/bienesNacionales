    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="<?= BASE_URL; ?>usuarios/guardar" id="form_usuario">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control bg-light" name="correo" id="correo" placeholder="Escriba el correo Electrónico">
                            </div>
                            <div class="form-group col-md-6 col-lg-4">
                                <label for="clave">Clave</label>
                                <input type="text" class="form-control bg-light" name="clave" id="clave" placeholder="Escriba el clave">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="rol" title="Tipo de Rol del Usuario">Tipo de Rol del Usuario</label>
                                <select class="form-control bg-light rol" name="rol" id="rol" >
