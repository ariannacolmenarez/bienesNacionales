    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <?php if(in_array("Crear Actas", $_SESSION['bn_permisos'])){ ?>
                    <a href="<?= BASE_URL; ?>bienes/registrarBienes" class="btn btn-primary btn-sm btn-icon-split">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th title="Numero de Acta">N Acta</th>
                                    <th>Codigo</th>
                                    <th>Nombre</th>
                                    <th >Fecha</th>
