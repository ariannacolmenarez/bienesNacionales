    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Modificar Encargado</h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL; ?>encargados/actualizar?c=<?=$_GET['c']?>" id="form_encargado">
                        <div class="form-row">
                        <?php $p=new encargadosModel; $r=$p->obtener($_GET['c']); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control bg-light" name="apellido" id="apellido" placeholder="Escriba el apellido" value="<?=$r->getapellido()?>">
                            </div>
                            <div class="form-group col-md-6 col-lg-4">
                                <label for="cargo" ><b>Cargo </b> </label>
                                <select class="form-control bg-light" name="cargo" id="cargo" >
                                    <?php
                                     encargados::selected($r->getid_cargo()); ?>
                                </select>
                                <span class="error"></span>
                            </div>
                            <div class="form-group col-md-6 col-lg-4">
                                <label for="cedula"><b>Cédula</b></label>
                                <input type="text" class="form-control bg-light" name="cedula" id="cedula" placeholder="Escriba la cédula" value="<?=$r->getcedula()?>">
                            </div>
                            <div class="form-group col-md-6 col-lg-4">
                                <label for="telefono"><b>Teléfono</b></label>
                                <input type="text" class="form-control bg-light" name="telefono" id="telefono"  placeholder="Escriba el teléfono" value="<?=$r->gettelefono()?>">
                            </div>
                        </div>
