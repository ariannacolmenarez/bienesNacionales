    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Registrar Cargos</h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL; ?>cargos/guardar" id="form" >
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="cargo"><b>Nombre del Cargo</b></label>
                                <input type="text" class="form-control bg-light" name="cargo" id="nombre" placeholder="Escriba el apellido">
                            </div>
                        </div>
