    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Registrar Módulos</h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL; ?>modulos/guardar">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="nombre"><b>Nombre</b></label>
                                <input type="text" class="form-control bg-light" name="nombre"  placeholder="Escriba el nombre" maxlength="50" pattern="[a-zA-ZÀ-ÿ\s0-9]{2,75}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="descripcion"><b>Descripción</b></label>
                                <input type="text" class="form-control bg-light" name="descripcion" placeholder="Escriba el apellido"maxlength="250" pattern="[a-zA-ZÀ-ÿ\s0-9]{2,250}" required>
                            </div>
                        </div>
