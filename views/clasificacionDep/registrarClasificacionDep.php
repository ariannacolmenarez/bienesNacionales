    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Registrar Clasificación de las dependencias</h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL; ?>clasificacionDep/guardar" id="form">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="clasificacionDep"><b>Nombre de la clasificación</b></label>
                                <input type="text" class="form-control bg-light" name="clasificacionDep" id="nombre" placeholder="Escriba el nombre"maxlength="50" pattern="[a-zA-ZÀ-ÿ\s0-9]{2,50}" required>
                            </div>
                        </div>
