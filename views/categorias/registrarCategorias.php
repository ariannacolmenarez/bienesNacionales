    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Registrar Categorias SIGECOF</h1>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL; ?>categorias/guardar" id="form_categoria">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="codigos"><b>Codigo</b></label>
                                <input type="text" class="form-control bg-light" name="codigos" id="codigo"  placeholder="Ingrese codigo">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="presupuestaria"><b>Presupuestaria</b></label>
                                <input type="text" class="form-control bg-light" name="presupuestaria" id="presupuestaria" placeholder="Escriba la presupuestaria">
                            </div>
                            ...
                            <div class="form-group col-md-6 col-lg-4">
                                ...
                                <select class="form-control bg-light" name="denominacion" id="denominacion">
                                    <option selected disabled>Seleccione una Denominación</option>
