        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Estadísticas de bienes por dependencias</h6>
                </div>
                <div class="card-body">
                <form method="POST" action="<?= BASE_URL; ?>reportes/estadisticaBienesDependencias" id="form">
                        <div class="form-row">
