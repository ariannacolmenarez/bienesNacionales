        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Reportes de Invetario por dependencias</h6>
                </div>
                <div class="card-body">
                <form method="POST" action="<?= BASE_URL; ?>reportes/pdfInventarioDep" id="form" >
                        <div class="form-row justify-content-md-center">
                            <div class="form-group col-md-6 col-lg-4">
                                <label for="dependencia" ><b>Dependencias</b></label>
                                <select class="form-control bg-light" name="dependencia" id="dependencia">
                                    <option selected disabled>Selecciona una dependencia</option>
                                    <?= reportes::select_dependencias(0); ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
