    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Modificar tipo de Reasignacion
                </h1>
                <a href="<?= BASE_URL; ?>tipoReasignacion" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?= BASE_URL; ?>tipoReasignacion/actualizar?c=<?=$_GET['c']?>" id="form" >
                        <div class="form-row">
                        <?php $p=new tipoReasignacionModel; $r=$p->obtener($_GET['c']); ?>
                            <div class="form-group col-md-6">
                                <label for="id"> <b>ID</b></label>
                                <input type="text" class="form-control bg-light" name="id"  placeholder="ID generado" value="<?=$r->getid_tipo()?>" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="tipo"><b>tipo de Reasignacion</b></label>
                                <input type="text" class="form-control bg-light" name="tipoReasignacion" id="nombre" placeholder="Escriba el nombre de tipo de reasignacion" value="<?=$r->gettipo()?>" maxlength="50" pattern="[a-zA-ZÀ-ÿ\s0-9]{2,75}" required>
                            </div>
                        </div>
